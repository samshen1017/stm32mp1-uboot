...
In the U-Boot source directory (sources/*/u-boot-stm32mp-v2021.10-stm32mp-r2-r0),
you have one U-Boot source tarball, the patches and one Makefile:
   - u-boot-stm32mp-v2021.10-stm32mp-r2-r0.tar.xz
   - 00*.patch
   - Makefile.sdk
...
----------------------------------------------------
    ...
    Branch: v2021.10-stm32mp
    Revision: v2021.10-stm32mp-r2

    $ git clone https://github.com/STMicroelectronics/u-boot.git
    $ git checkout -b WORKING v2021.10-stm32mp-r2
